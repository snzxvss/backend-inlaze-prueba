...
DELIMITER //
CREATE PROCEDURE sp_get_user_by_id(IN user_id VARCHAR(36))
BEGIN
    SELECT 
        id,
        name,
...
DELIMITER //
CREATE PROCEDURE sp_get_user_by_email(IN user_email VARCHAR(255))
BEGIN
    SELECT 
        id,
        name,
...
DELIMITER //
CREATE PROCEDURE sp_get_users_by_role(IN user_role VARCHAR(20))
BEGIN
    SELECT 
        id,
        name,
...
-- Eliminar usuario
DELIMITER //
CREATE PROCEDURE sp_delete_user(IN user_id VARCHAR(36))
BEGIN
